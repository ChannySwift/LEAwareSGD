...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate, depth, reduction, n_classes, bottleneck, contrastive='contrastive'):
        ...
        if 'contrastive' in contrastive:
            self.pro_head = nn.Linear(n_channels, 128)
...
def densenet(growth_rate=12, depth=40, num_classes=10,contrastive='contrastive'):
    model = DenseNet(growth_rate, depth, 1., num_classes, False,contrastive='contrastive')
    return model
